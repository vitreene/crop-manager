...
var plateContainer; // DOM du conteneur image
var prefixedTransform; // propriété transform selon le navigateur
...
// react ->
/*
composant conteneur de l'image.
met à jour ses propriétés transform
v1: le composant réagi à deux boutons rotate gauche et droite.
*/
...
function handleGesture(x1, y1, x2, y2) {
  ...
  if (input.isGesture) {
    ...
    // console.log("touchDistance,touchAngle", Math.round(touchDistance),Math.round(touchAngle*100) );
    var scalePixelChange = touchDistance - input.touchStartDistance;
    var angleChange = touchAngle - input.touchStartAngle;
    //calculate how much this should affect the actual object

    //console.log('touchDistance, touchStartDistance', Math.round(touchDistance) , Math.round(input.touchStartDistance) );
    //console.log('touchAngle, touchStartAngle', touchAngle , input.touchStartAngle);
    //console.log("scalePixelChange,angleChange", Math.round(scalePixelChange),Math.round(angleChange*100), '\n' );
